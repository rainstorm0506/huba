...
function addImage(src) {
    var newElement = "<li><img class='content'  src='" + src + "' style=\"width:100px;height:100px;\"><img class='button' src=" + "./assets/images/uplodify/fancy_close.png></li>";
...
var del = function () {
    ...
    $.ajax({
        ...
        url: "/index.php?r=global/delImg&act=del", //调用WebService的地址和方法名称组合---WsURL/方法名
        data: "src=" + src,
